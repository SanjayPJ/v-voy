...
<head>
    ...
    <title>Vimanam - Drone Services in India | Drone Survey in India| Aerial Survey in India | Aerial Inspection in
        India | Aerial Mapping in India | Infrastructure Drone Survey | Wind Turbine Inspection | Solar Panel
        Inspection | Aerial Photography and Videography</title>
        ...
        <div class="w-80 py-5">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6">
                    <div class="row">
                        <div class="col-2">
                            <img src="assets/img/drone.svg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-6 spacer-md">
                    <div class="row">
                        <div class="col-2">
                            <img src="assets/img/drone1.svg" alt="">
                        </div>
                        <div class="col-10 text-white">
            ...
            <div class="row spacer">
                <div class="col-12 col-sm-12 col-md-6">
                    <div class="row">
                        <div class="col-2">
                            <img src="assets/img/smart-farm.svg" alt="">
                        </div>
                        <div class="col-10 text-white">
                ...
                <div class="col-12 col-sm-12 col-md-6 spacer-md">
                    <div class="row">
                        <div class="col-2">
                            <img src="assets/img/remote-control.svg" alt="">
                        </div>
                        <div class="col-10 text-white">
                ...
                <div class="ninp">
                    <div class="row pr-5 pl-3">
                        <div class="newspaper px-3">
                            ...
                            <img class="rounded" src="assets/img/Arveen-Raj1.jpeg" alt="">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="row back-b no-gutters">
                                <div class="col-6" id="lightgallery">
                                    <a href="assets/img/1g.jpg">
                                        <img style="width: 100%; height: 100%" src="assets/img/1g.jpg" alt="">
                                    </a>
                                </div>
                                <div class="col-6">
                                    <div id="video-gallery">
                                        <a href="https://youtu.be/HCx6zyKUkjA" data-poster="assets/img/2ge.jpg">
                                            <img style="width: 100%; height: 100%" src="assets/img/2ge.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div id="video-gallery1" class="back-b">
                                        <a href="https://youtu.be/Ds2PYdTX4cs" data-poster="assets/img/3ge.jpg">
                                            <img style="width: 100%; height: 100%" src="assets/img/3ge.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="row no-gutters back-b">
                                <div class="col-6 col-md-12" id="lightgallery1">
                                    <a href="assets/img/5g-f.jpg">
                                        <img class="gf" style="width: 99%; height: 100%" src="assets/img/5g.jpg" alt="">
                                    </a>
                                </div>
                                <div class="col-6 col-md-12" id="lightgallery2">
                                    <a href="assets/img/4g.jpg">
                                        <img style="width: 98%; height: 100%" src="assets/img/4g.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="ninp mt-5">
                    ...
                    <div class="row my-5 pt-3 text-center">
                        ...
                        <div class="col-4 col-md-2">
                            <img src="assets/img/2c.png" alt="">
                        </div>
                        <div class="col-4 col-md-2 spacer-md">
                            <img src="assets/img/3c.png" alt="">
                        </div>
                        <div class="col-4 col-md-2 spacer-md">
                            <img src="assets/img/4c.png" alt="">
                        </div>
                        <div class="col-4 col-md-2 spacer-md">
                            <img src="assets/img/5c.png" alt="">
                        </div>
                        <div class="col-4 col-md-2 spacer-md">
                            <img src="assets/img/6c.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ninp mt-3">
                    <div class="row">
                        <div class="col-6 col-md-3">
                            <img class="rounded" src="assets/img/1f.jpg" alt="">
                        ...
                        <div class="col-6 col-md-3">
                            <img class="rounded" src="assets/img/2f.jpg" alt="">
                        ...
                        <div class="col-6 col-md-3 spacer-md">
                            <img class="rounded" src="assets/img/3f.jpg" alt="">
                        ...
                        <div class="col-6 col-md-3 spacer-md">
                            <img class="rounded" src="assets/img/4f.jpg" alt="">
            ...
            <div class="row pb-4">
                ...
                <div class="col-12 col-sm-4">
                    <h4 class="">OUR BLOG</h4>
                                             <div class="row">
                                                                        <div class="pt-3 mt-4 blog-section card bg-transparent border border-0">
                          <div class="row no-gutters">
                              <div class="col-3 col-md-4 back-b px-3">
                              <img class="img-fluid" src="/assets/img/1b.jpg" alt="Blog Image 1">
                              </div>
                              <div class="col-9 col-md-8">
                                  <a href="/blog/7" class="text-white"><h5 class="text-uppercase">How Do Drones Work And What Is Drone Technology</h5></a>
                                  <p></p><p>What is a drone and how do drones work is answered here in this easy to understand article. Drone technology is constantly evol...</p>
                              </div>
                          </div>
                      </div>
                                                                        <div class="pt-3 mt-4 blog-section card bg-transparent border border-0">
                          <div class="row no-gutters">
                              <div class="col-3 col-md-4 back-b px-3">
                              <img class="img-fluid" src="/assets/img/2b.jpg" alt="Blog Image 1">
                              </div>
                              <div class="col-9 col-md-8">
                                  <a href="/blog/3" class="text-white"><h5 class="text-uppercase">Types of Drones – Explore the Different Models of UAV’s</h5></a>
                                  <p></p><p>A “<strong>Drone</strong>” is basically an Unmanned Aerial Vehicle(UAV) &nbsp;– an aircraft without a human p...</p>
                              </div>
                          </div>
                      </div>
                                                                        </div>
                                        <hr>
                    <a href="/blog" class="btn btn-sm ghostbtn mt-1"><span class="">SHOW ALL</span></a>
                </div>
                <div class="col-12 col-sm-3 spacer-md">
                    ...
                    <hr>
                    <a href="/faqs" class="btn btn-sm ghostbtn mt-1"><span class="">FAQ'S</span></a>
                </div>
            </div>
